...
from utilities import load_yaml, ExperimentLogger
...
def train(cfg, mode: str = "rgb", epochs: int = 40, batch_size: int = 32,
          pretrained: bool = True, topk: int = 10, seed_for_train: int = 42):
    ...
    save_path_model = f"../checkpoints/object_best_{mode}_seed_{seed_for_train}_model_{model_name}_lowlight.pth"
    save_path_outcome = f"../outcomes/object_outcomes_{model_name}_lowlight.csv"
...
if __name__ == "__main__":
    ...
    # set_global_seed(42)
    # cfg["dataset"]["model"]["name"] = "resnet18"
    cfg["dataset"]["model"]["name"] = "vit"

    # train(cfg, mode="rgbd", epochs=40, batch_size=32, pretrained=True, topk=10)
